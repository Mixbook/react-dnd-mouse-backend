...
var MouseBackend = function () {
  ...
  _createClass(MouseBackend, [{
    ...
    value: function handleWindowMoveStart(e) {
      ...
      if (e.target.tagName !== 'INPUT' && e.target.tagName !== 'SELECT' && e.target.tagName !== 'TEXTAREA' && document.activeElement.tagName !== 'INPUT' && document.activeElement.tagName !== 'SELECT' && document.activeElement.tagName !== 'TEXTAREA' && !e.target.isContentEditable) {
        e.preventDefault();
      }
    ...
    value: function handleWindowMoveCapture(e) {
      ...
      var sortedMatchingTargetIds = matchingTargetIds.sort(function (a, b) {
        return _this4.getParents(_this4.targetNodes[a]).indexOf(_this4.targetNodes[b]) !== -1 ? 1 : -1;
      });
